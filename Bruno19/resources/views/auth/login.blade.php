                            ...
                            <div class="card-body ">
                                <div class="card-body">
                                    <div class="form-group">
                                        <label for="user" class="col-md-6 col-form-label">{{ __('User Name') }}</label>
            
                                        <div class="col-md-14">
                                            <input id="user" type="text" class="form-control @error('user') is-invalid @enderror" name="user" value="{{ old('user', 'admin') }}" required autocomplete="off" autofocus>
