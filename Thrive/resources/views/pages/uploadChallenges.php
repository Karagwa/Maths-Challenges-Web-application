...
// Prepare and bind
$stmt = $conn->prepare("INSERT INTO challenges (ChallengeNo,ChallengeName,OpeningDate,ClosingDate,ChallengeDuration,NumberOfPresentedQuestions) VALUES (?, ?, ?, ?, ?, ?)");
$stmt->bind_param("ssss", $ChallengeNo, $ChallengeName, $OpeningDate, $ClosingDate, $ChallengeDuration, $NumberOfPresentedQuestions);
$stmt->execute();
// Execute and check
$response = "";
