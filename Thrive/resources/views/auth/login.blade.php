...
@section('content')
    <div class="full-page section-image" data-color="" data-image="{{ asset('light-bootstrap/img/full-screen-image-2.jpg') }}">
                    ...
                    <form class="form" method="POST" action="{{ route('login') }}">
                        ...
                        <div class="card card-login card-hidden">
                            <div class="card-header ">
                                <h2 class="header text-center">{{'For Adminstrator use only!'}}</h2>
                                <h3 class="header text-center">{{ __('Adminstartor Login') }}</h3>
                            </div>
                            <div class="card-body ">
                                <div class="card-body">
